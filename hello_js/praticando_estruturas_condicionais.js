...
let data_atual = new Date(); //Objeto date que pega a data do sistema
let mes_atual = data_atual.getMonth(); //Método getMonth() para retornar o mês atual, que vai de 0 a 11

//If pelos números do mês
